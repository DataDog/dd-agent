    ...
    def _define_params(self, version):
        ...
        if int(version[0:1]) >= 1 or version in ["0.90.10", "0.90.11"]:
            ...
            self.METRICS = {
                ...
                "jvm.gc.concurrent_mark_sweep.count": ("gauge", "jvm.gc.collectors.old.collection_count"),
                "jvm.gc.concurrent_mark_sweep.collection_time": ("gauge", "jvm.gc.collectors.old.collection_time_in_millis", lambda v: float(v)/1000),
                "jvm.gc.par_new.count": ("gauge", "jvm.gc.collectors.young.collection_count"),
                "jvm.gc.par_new.collection_time": ("gauge", "jvm.gc.collectors.young.collection_time_in_millis", lambda v: float(v)/1000),
