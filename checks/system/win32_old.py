...
class Cpu(Check):
    ...
    def check(self, agentConfig):
        ...
        self.save_sample('old.system.cpu.user', 100 * cpu_percent.user / psutil.NUM_CPUS)
        self.save_sample('old.system.cpu.idle', 100 * cpu_percent.idle / psutil.NUM_CPUS)
        self.save_sample('old.system.cpu.system', 100 * cpu_percent.system / psutil.NUM_CPUS)
