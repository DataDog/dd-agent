...
class Collector(object):
    ...
    def __init__(self, agentConfig, emitters, systemStats, jmxfetch_pid=None):
        ...
        self.jmxfetch_pid = jmxfetch_pid
    ...
    def stop(self):
        ...
        if self.jmxfetch_pid is not None:
            try:
                log.info("Killing JMX Fetch")
                os.kill(self.jmxfetch_pid, signal.SIGKILL)
                log.info("Success")
            except Exception:
                log.error("Couldn't kill jmxfetch pid %s" % self.jmxfetch_pid)
