...
class EtcdTest(AgentCheckTest):
    ...
    def test_metrics(self):
        ...
        self.assertMetric('etcd.store.gets.success', value=0.0, tags=tags)
        self.assertMetric('etcd.store.gets.fail', value=0.0, tags=tags)
        self.assertMetric('etcd.self.send.appendrequest.count', value=0.0, tags=tags)
